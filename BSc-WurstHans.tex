...
\documentclass[german]{scrreprt}       % Dokumentklasse aus dem KOMA-Script-Paket
...
\input{LaTeX-Header/chemie}
\input{LaTeX-Header/bibliographie}
\input{LaTeX-Header/listings}
...
%\include{Includes/publikationen}
...
\include{Includes/anhang-header}
